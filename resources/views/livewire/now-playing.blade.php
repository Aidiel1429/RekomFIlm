<div>
    ...
    <div wire:init="loadNowPlaying">
        <div wire:loading wire:target="loadNowPlaying">
            <p>LOading...</p>
        </div>

        <div wire:loading.remove class="mt-3 overflow-x-auto custom-scroll snap-x snap-mandatory md:mt-7">
            <div
