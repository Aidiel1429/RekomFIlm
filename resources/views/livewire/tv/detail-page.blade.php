<div x-data="{ scrollCast: null, scrollSimilar: null, scrollRecom: null, scrollReview: null }" x-init="scrollCast = $refs.scrollCast, scrollSimilar = $refs.scrollSimilar, scrollRecom = $refs.scrollRecom, scrollReview = $refs.scrollReview">
    ...
    <div loading="lazy" class="w-full flex-shrink-0 relative bg-center bg-cover h-40 sm:h-56 lg:h-[450px] xl:h-[550px]"
        ...
        <div
            ...
            <div class="lg:flex lg:gap-10 items-center xl:px-14">
                ...
                <div class="hidden lg:block">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex items-center gap-5 mt-2 text-sm md:text-lg">
                            ...
                            <div>|</div>
                            <p>{{ \Carbon\Carbon::parse($details['first_air_date'])->format('d M Y') }}</p>
                            <div>|</div>
                            @if (!empty($details['number_of_seasons']) && !empty($details['number_of_episodes']))
                                <p class="text-white text-sm md:text-base">
                                    {{ $details['number_of_seasons'] }}
                                    Season{{ $details['number_of_seasons'] > 1 ? 's' : '' }},
                                    {{ $details['number_of_episodes'] }}
                                    Episode{{ $details['number_of_episodes'] > 1 ? 's' : '' }}
                                </p>
                            @endif
                        </div>
                    </div>
            ...
            <div class="lg:flex lg:gap-10">
                <div class="mt-4 lg:hidden">
                    <div class="text-sm grid grid-cols-2 gap-2 md:text-lg">
                        ...
                        <div>
                            ...
                            <p>{{ $details['production_countries'][0]['name'] }}</p>
                        </div>
                        <div>
                ...
                <div class="lg:w-2/3">
                                    ...
                                    <a
                                        ...
                                        <div
                                            ...
                                            <div class="mt-4 leading-tight text-start">
                                                ...
                                                <p class="text-sm text-white/80 lg:text-base xl:text-lg leading-5">
                                                    {{ $item['character'] }}</p>
                                            </div>
                                        </div>
                                    </a>
                    ...
                    @if (count($details['similar']['results']) > 0)
                        <div class="mt-4 lg:mt-7">
                            <div class="lg:flex lg:justify-between items-center">
                                <h1 class="font-bold text-xl lg:text-2xl xl:text-3xl">Similar Tv Shows</h1>
                                <div class="hidden lg:flex items-center gap-2">
                            ...
                            <div x-ref="scrollSimilar"
                                ...
                                <div class="flex gap-5 min-w-max">
                                    @foreach ($details['similar']['results'] as $item)
                                        <a href="/tv/{{ $item['id'] }}/{{ \Illuminate\Support\Str::slug($item['name']) }}"
                                            wire:navigate>
                                            <div
                    ...
                    @if (count($details['recommendations']['results']) > 0)
                        <div class="mt-4 lg:mt-7">
                            <div class="lg:flex lg:justify-between items-center">
                                <h1 class="font-bold text-xl lg:text-2xl xl:text-3xl">Recomended Tv Shows</h1>
                                <div class="hidden lg:flex items-center gap-2">
                                    ...
                                    @foreach ($details['reviews']['results'] as $item)
                                        <a href="{{ $item['url'] }}" target="_blank">
                                            <div
                                                ...
                                                <div
                                                    class="font-semibold text-white flex items-center justify-between gap-5 xl:text-xl">
                ...
                <div class="mt-4 hidden lg:block lg:w-1/3">
                    ...
                    <div class="text-lg mt-4">
                        ...
                        <div class="mt-2">
                            <h1 class="font-semibold">Production Country</h1>
                            <p class="ml-2">{{ $details['production_countries'][0]['name'] }}</p>
                        </div>
                        <div class="mt-2">
                            <h1 class="font-semibold">Popularity</h1>
